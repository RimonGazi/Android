...
public class LogExpendableAdapter extends CursorTreeAdapter {
	private LayoutInflater mInflator;
	private Context context;
	private LogListener listener;
	private LogTextFormatWithSpan textFormat;

	public LogExpendableAdapter(Cursor cursor, Context context) {
		super(cursor, context);
		this.context = context;
		mInflator = LayoutInflater.from(context);
		listener = (PatientLog) context;
	}
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		AnyButtonWithTitleText btn_save, btn_print, btn_export;
		...
		view = mInflator.inflate(R.layout.log_spendable_list_child, null);
		...
		btn_export = (AnyButtonWithTitleText) view
		...
		btn_print.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				listener.onCallBack(true, false, false, getGroup(gp));
			}
		});
		...
		btn_save.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				listener.onCallBack(false, true, false, getGroup(gp));
			}
		});
		btn_export.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				listener.onCallBack(false, false, true, getGroup(gp));
			}
		});
