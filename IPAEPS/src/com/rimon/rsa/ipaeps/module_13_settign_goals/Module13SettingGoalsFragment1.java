...
public class Module13SettingGoalsFragment1 extends SherlockFragment implements
	...
	private AnyButton btn_ga_q_module_13_1, btn_sg_q_module_13_2;
	private EditText et_sg_module_13_2;
	private String ga_1 = "";
	private String sg_1 = "";
	...
	private AnyTextView tv_module_13_title_1, tv_q_module_13_1,
			tv_module_13_goal_title_1, tv_score_1, tv_score_2, tv_score_3,
			tv_13_sk_2, tv_13_sk_1;

	private View view;
	private SpannableStringBuilder spannableString;
	private CustomTypefaceSpan customTypefaceSpan;
	private SeekBar skb__q_module_13_3;
	private int skb__q_module_13_3_value = -1;
	private int array_btn_13_2 = -1;

	@Override
	public void onAttach(Activity activity) {
		super.onAttach(activity);
		listener = (Module13SettingGoals) getActivity();
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		bundle = new Bundle();
		view = inflater.inflate(R.layout.module_13_goals_fragment_1, null,
				false);

		layout = (LinearLayout) view.findViewById(R.id.linear_layout_goal_13_1);
	...
	private void enableView() {
		tv_module_13_title_1 = (AnyTextView) view
				.findViewById(R.id.tv_module_13_title_1);
		tv_module_13_title_1.setEnabled(true);
		tv_q_module_13_1 = (AnyTextView) view
				.findViewById(R.id.tv_q_module_13_1);
		tv_q_module_13_1.setEnabled(true);
		btn_ga_q_module_13_1 = (AnyButton) view
				.findViewById(R.id.btn_ga_q_module_13_1);
		btn_ga_q_module_13_1.setEnabled(true);
		btn_ga_q_module_13_1.setOnClickListener(this);
		btn_sg_q_module_13_2 = (AnyButton) view
				.findViewById(R.id.btn_sg_q_module_13_2);
		btn_sg_q_module_13_2.setOnClickListener(this);

		et_sg_module_13_2 = (EditText) view
				.findViewById(R.id.et_sg_module_13_2);
		et_sg_module_13_2.addTextChangedListener(new TextWatcher() {
		...
		tv_module_13_goal_title_1 = (AnyTextView) view
				.findViewById(R.id.tv_module_13_goal_title_1);
		tv_module_13_goal_title_1.setEnabled(true);
		...
		skb__q_module_13_3 = (SeekBar) view
				.findViewById(R.id.skb__q_module_13_3);
		skb__q_module_13_3.setEnabled(true);
		skb__q_module_13_3
		...
		tv_13_sk_2 = (AnyTextView) view.findViewById(R.id.tv_13_sk_2);
		tv_13_sk_2.setEnabled(true);

		tv_13_sk_1 = (AnyTextView) view.findViewById(R.id.tv_13_sk_1);
		tv_13_sk_1.setEnabled(true);
	}

	private void getValue() {

		AppConstants.q_module_13_1 = ga_1;

		if (et_sg_module_13_2.isEnabled()) {
			AppConstants.q_module_13_2 = et_c_sg_1;

		} else {
			AppConstants.q_module_13_2 = sg_1;
		}

		AppConstants.q_module_13_3 = String.valueOf(skb__q_module_13_3_value);

		Log.d("AppConstants.q_module_13_1", AppConstants.q_module_13_1);
		Log.d("AppConstants.q_module_13_2", AppConstants.q_module_13_2);
		Log.d("AppConstants.q_module_13_3", AppConstants.q_module_13_3);
	...
	public void onDialogSingleItemSelected(int view_id, String selected_item) {
		...
		switch (view_id) {
		case R.id.btn_ga_q_module_13_1:
			btn_ga_q_module_13_1.setText(selected_item);
			setLastStateGA(btn_ga_q_module_13_1);
			ga_1 = selected_item;
			et_sg_module_13_2.setText("");
			if (et_sg_module_13_2.isEnabled()) {
				et_sg_module_13_2.setEnabled(false);

			}
			if (btn_sg_q_module_13_2.isEnabled()) {
				btn_sg_q_module_13_2.setEnabled(false);
			}
			if (selected_item.equals(index_0)) {
				sg_1 = AppConstants.DEFULLT_DATA;

			} else if (selected_item.equals(index_1)) {
				et_sg_module_13_2.setEnabled(true);
				et_sg_module_13_2.requestFocus();
			} else {
				btn_sg_q_module_13_2.setEnabled(true);
				setArrayList(selected_item);
			}

			break;

		case R.id.btn_sg_q_module_13_2:
			sg_1 = selected_item;
			setLastStateSp(btn_sg_q_module_13_2);
			et_sg_module_13_2.setText(setTextColor(selected_item));
			break;
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.btn_ga_q_module_13_1:
			showDialog(R.array.array_modue_12_ga, R.id.btn_ga_q_module_13_1,
					R.string.general_area, ga_1);

			break;
		case R.id.btn_sg_q_module_13_2:

			showDialog(array_btn_13_2, R.id.btn_sg_q_module_13_2,
					R.string.specific_goal, sg_1);
			break;

		case R.id.btn_next:
			getValue();
			listener.pageChange(AppConstants.MODULE_13_PAGE_2);
		}

	}

	private void checkNextButtonVisible() {
		if (check_et() && (skb__q_module_13_3_value >= 0) && check_sg()
				&& check_ga()) {
