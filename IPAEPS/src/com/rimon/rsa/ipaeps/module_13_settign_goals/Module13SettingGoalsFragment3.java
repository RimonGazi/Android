...
public class Module13SettingGoalsFragment3 extends SherlockFragment implements
	...
	private AnyButton btn_ga_q_module_13_7, btn_sg_q_module_13_8;
	private EditText et_sg_module_13_8;
	private String ga_7 = "";
	private String sg_8 = "";
	...
	private SeekBar skb__q_module_13_9;
	private int skb__q_module_13_9_value = -1;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		bundle = new Bundle();
		view = inflater.inflate(R.layout.module_13_goals_fragment_3, null,
				false);
		enableView();
	...
	private void enableView() {
		...
		btn_ga_q_module_13_7 = (AnyButton) view
				.findViewById(R.id.btn_ga_q_module_13_7);

		btn_ga_q_module_13_7.setOnClickListener(this);
		btn_sg_q_module_13_8 = (AnyButton) view
				.findViewById(R.id.btn_sg_q_module_13_8);
		btn_sg_q_module_13_8.setOnClickListener(this);

		et_sg_module_13_8 = (EditText) view
				.findViewById(R.id.et_sg_module_13_8);
		et_sg_module_13_8.addTextChangedListener(new TextWatcher() {
		...
		skb__q_module_13_9 = (SeekBar) view
				.findViewById(R.id.skb__q_module_13_9);
	...
	private void getValue() {
		...
		if (ga_7.equals("")) {
			AppConstants.q_module_13_7 = AppConstants.DEFULLT_DATA;
		} else {
			AppConstants.q_module_13_7 = ga_7;
		}

		if (et_sg_module_13_8.isEnabled()) {
			if (et_c_sg_8.equals("")) {
				AppConstants.q_module_13_8 = et_c_sg_8;
			} else {
				AppConstants.q_module_13_8 = AppConstants.DEFULLT_DATA;
			}
			...
			if (sg_8.equals("")) {
				...
				AppConstants.q_module_13_8 = sg_8;
			}
		}

		if (skb__q_module_13_9_value == -1) {
			AppConstants.q_module_13_9 = AppConstants.DEFULLT_DATA;
		} else {
			AppConstants.q_module_13_9 = String
					.valueOf(skb__q_module_13_9_value);
		}
		Log.d("AppConstants.q_module_13_7", AppConstants.q_module_13_7);
		Log.d("AppConstants.q_module_13_8", AppConstants.q_module_13_8);
		Log.d("AppConstants.q_module_13_9", AppConstants.q_module_13_9);
	...
	public void onDialogSingleItemSelected(int view_id, String selected_item) {
		...
		switch (view_id) {
		case R.id.btn_ga_q_module_13_7:
			btn_ga_q_module_13_7.setText(selected_item);
			setLastStateGA(btn_ga_q_module_13_7);
			ga_7 = selected_item;
			et_sg_module_13_8.setText("");
			if (et_sg_module_13_8.isEnabled()) {
				et_sg_module_13_8.setEnabled(false);

			}
			if (btn_sg_q_module_13_8.isEnabled()) {
				btn_sg_q_module_13_8.setEnabled(false);
			}
			if (selected_item.equals(index_0)) {
				sg_8 = AppConstants.DEFULLT_DATA;

			} else if (selected_item.equals(index_1)) {
				et_sg_module_13_8.setEnabled(true);
				et_sg_module_13_8.requestFocus();
			} else {
				btn_sg_q_module_13_8.setEnabled(true);
				setArrayList(selected_item);
			}

			break;

		case R.id.btn_sg_q_module_13_8:
			sg_8 = selected_item;
			setLastStateSp(btn_sg_q_module_13_8);
			et_sg_module_13_8.setText(setTextColor(selected_item));
			break;
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.btn_ga_q_module_13_7:
			showDialog(R.array.array_modue_12_ga, R.id.btn_ga_q_module_13_7,
					R.string.general_area, ga_7);

			break;
		case R.id.btn_sg_q_module_13_8:

			showDialog(array_btn_13_2, R.id.btn_sg_q_module_13_8,
	...
	// if (check_et() && (skb__q_module_13_9_value > 0) && check_sg()
	// && check_ga()) {
	// btn_next.setEnabled(true);
	// } else {
