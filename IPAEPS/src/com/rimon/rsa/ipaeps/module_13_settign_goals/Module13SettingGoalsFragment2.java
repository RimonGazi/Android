...
public class Module13SettingGoalsFragment2 extends SherlockFragment implements
	...
	private AnyButton btn_ga_q_module_13_4, btn_sg_q_module_13_5;
	private EditText et_sg_module_13_5;
	private String ga_4 = "";
	private String sg_5 = "";
	...
	private SeekBar skb__q_module_13_6;
	private int skb__q_module_13_6_value = -1;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		bundle = new Bundle();
		view = inflater.inflate(R.layout.module_13_goals_fragment_2, null,
				false);
		enableView();
	...
	private void enableView() {
		...
		btn_ga_q_module_13_4 = (AnyButton) view
				.findViewById(R.id.btn_ga_q_module_13_4);

		btn_ga_q_module_13_4.setOnClickListener(this);
		btn_sg_q_module_13_5 = (AnyButton) view
				.findViewById(R.id.btn_sg_q_module_13_5);
		btn_sg_q_module_13_5.setOnClickListener(this);

		et_sg_module_13_5 = (EditText) view
				.findViewById(R.id.et_sg_module_13_5);
		et_sg_module_13_5.addTextChangedListener(new TextWatcher() {
		...
		skb__q_module_13_6 = (SeekBar) view
				.findViewById(R.id.skb__q_module_13_6);
	...
	private void getValue() {
		if (ga_4.equals("")) {
			AppConstants.q_module_13_4 = AppConstants.DEFULLT_DATA;
		} else {
			AppConstants.q_module_13_4 = ga_4;
		}

		if (et_sg_module_13_5.isEnabled()) {
			if (et_c_sg_5.equals("")) {
				AppConstants.q_module_13_5 = et_c_sg_5;
			} else {
				AppConstants.q_module_13_5 = AppConstants.DEFULLT_DATA;
			}
			...
			if (sg_5.equals("")) {
				...
				AppConstants.q_module_13_5 = sg_5;
			}
		}

		if (skb__q_module_13_6_value == -1) {
			AppConstants.q_module_13_6 = AppConstants.DEFULLT_DATA;
		} else {
			AppConstants.q_module_13_6 = String
					.valueOf(skb__q_module_13_6_value);
		}
		Log.d("AppConstants.q_module_13_4", AppConstants.q_module_13_4);
		Log.d("AppConstants.q_module_13_5", AppConstants.q_module_13_5);
		Log.d("AppConstants.q_module_13_6", AppConstants.q_module_13_6);
	...
	public void onDialogSingleItemSelected(int view_id, String selected_item) {
		...
		switch (view_id) {
		case R.id.btn_ga_q_module_13_4:
			setLastStateGA(btn_ga_q_module_13_4);
			btn_ga_q_module_13_4.setText(selected_item);
			ga_4 = selected_item;
			et_sg_module_13_5.setText("");
			if (et_sg_module_13_5.isEnabled()) {
				et_sg_module_13_5.setEnabled(false);

			}
			if (btn_sg_q_module_13_5.isEnabled()) {
				btn_sg_q_module_13_5.setEnabled(false);
			}
			if (selected_item.equals(index_0)) {
				sg_5 = AppConstants.DEFULLT_DATA;

			} else if (selected_item.equals(index_1)) {
				et_sg_module_13_5.setEnabled(true);
				et_sg_module_13_5.requestFocus();
			} else {
				btn_sg_q_module_13_5.setEnabled(true);
				setArrayList(selected_item);
			}

			break;

		case R.id.btn_sg_q_module_13_5:
			sg_5 = selected_item;
			setLastStateSp(btn_sg_q_module_13_5);
			et_sg_module_13_5.setText(setTextColor(selected_item));
			break;
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.btn_ga_q_module_13_4:
			showDialog(R.array.array_modue_12_ga, R.id.btn_ga_q_module_13_4,
					R.string.general_area, ga_4);

			break;
		case R.id.btn_sg_q_module_13_5:

			showDialog(array_btn_13_2, R.id.btn_sg_q_module_13_5,
					R.string.specific_goal, sg_5);
			break;

		case R.id.btn_next:
			getValue();
			listener.pageChange(AppConstants.MODULE_13_PAGE_3);
			break;
		case R.id.btn_previous:
			listener.pageChange(AppConstants.MODULE_13_PAGE_1);
			break;
	...
	// if (check_et() && (skb__q_module_13_6_value >= 0) && check_sg()
	// && check_ga()) {
	// btn_next.setEnabled(true);
	// } else {
