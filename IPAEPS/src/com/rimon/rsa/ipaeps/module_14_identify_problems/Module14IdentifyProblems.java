...
public class Module14IdentifyProblems extends SherlockFragmentActivity
		implements AnyPageChangeListener, AnyDialogPasswordListener {

	private AnySwipeableViewPager pager;
	private IdentifySectionsPagerAdapter adapter;
	...
	protected void onCreate(Bundle arg0) {
		super.onCreate(arg0);
		setContentView(R.layout.module_14_identify_problem_main);
		tv_action_bar = (AnyTextView) findViewById(R.id.tv_action_bar);
		tv_action_bar.setText(this.getResources().getString(
				R.string.identifying_problems));
		im_action_bar = (ImageView) findViewById(R.id.im_action_bar);
		im_action_bar.setBackgroundResource(R.mipmap.ic_identifying_problems);
		pager = (AnySwipeableViewPager) findViewById(R.id.iden_p_pager);
		adapter = new IdentifySectionsPagerAdapter(getSupportFragmentManager());
		try {
