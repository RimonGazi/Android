...
import com.rimon.rsa.ipaeps.pdf.Pdf;

public class PatientReportQuestionPdf {
	...
	public PatientReportQuestionPdf(Context paramContext) {
	...
	public void SavePdf(String paramString, Cursor paramCursor,
			ReportModuleSettingData moduleSettingData) {
